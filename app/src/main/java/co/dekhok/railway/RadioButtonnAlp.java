...
public class RadioButtonnAlp extends AppCompatActivity {
    ...
    protected void onPause() {
        ...
        Log.e("engineering",edt1.getText().toString());
        ...
        Log.e("abhinewabnormal",data_new+"");
        super.onPause();
    }

    @Override
    protected void onDestroy() {
        Log.e("inquestiondestroy","inquestiondestroy");
        finishAffinity();
        super.onDestroy();
    }
    ...
    void  subMitLocal()
    {
        DatabaseHandler db = new DatabaseHandler(RadioButtonnAlp.this);
        ...
        rqmodel.setRefId(sessionManager.getRefKey(RadioButtonnAlp.this));
        int id = db.cerateQuestionRadioAlp(rqmodel);
        if (id>0)
        {
            arrayValue.clear();
            Intent intent = new Intent(RadioButtonnAlp.this, AlpForm.class);
    ...
    void submit() {
        final ProgressDialog pd = new ProgressDialog(RadioButtonnAlp.this);
        ...
        StringRequest req = new StringRequest(StringRequest.Method.POST, Config.SeverUrl + "answer.php", new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                if(response != null && response.data != null){
                    ...
                    androidx.appcompat.app.AlertDialog.Builder alertDialogBuilder = new androidx.appcompat.app.AlertDialog.Builder(RadioButtonnAlp.this);
    ...
    void parse(String response) {
        try {
            ...
            if (jsonObject.getString("status").equals("Success")) {
                arrayValue.clear();
                Log.e("abhisheksharma", "abhisheksharma");
                Log.e("abhisheksharmanew", jsonObject + "");
                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(
                        RadioButtonnAlp.this);
